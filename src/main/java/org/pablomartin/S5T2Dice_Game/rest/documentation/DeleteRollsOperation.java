...
@Operation(
        summary = "Request for reset the player's game.",
        description = "Removes all player's info related to the game (rolls, statistics ...).\n\n" +
        ...
        responses = {
                @ApiResponse(
                        description = "On success: all the rolls have been removed and statistics have been reset.",
                        responseCode = "204",
                        content = @Content),
                @ApiResponse(
...
@Target(METHOD)
@Retention(RUNTIME)
public @interface DeleteRollsOperation {
}
